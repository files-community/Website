export default function rainbowCanvas(node) {
  /*
   ...
   */
  const gradient = new Gradient().initGradient(node);

  // Simple listener to update colors when the user's theme changes, since we use CSS variables in some places
  window
