    ...
    <table>
      ...
      {#each cloudFiles as { name, icon, status }, i}
        <tr style="--file-index: {i}">
          <td>
            <img src="/ui/icons/{icon}.png" alt={icon === "folder" ? `${icon} file` : "Folder"} width="24"
                 height="24" />
          </td>
          <td>{name}</td>
...
{:else if feature === 1}
  <svg class="backdrop-icon" width="48" height="48" style="--icon-scale: 0.9; --icon-stroke-width: 0.3"
       viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    <path in:draw={{ duration: 1250 }}
...
{:else if feature === 2}
  <svg class="backdrop-icon" style="--icon-scale: 0.75" width="32" height="32" viewBox="0 0 32 32"
       xmlns="http://www.w3.org/2000/svg">
    <path in:draw={{ duration: 1200 }}
...
{:else if feature === 3}
  <svg class="backdrop-icon" height="20" style="--icon-scale: 0.9; --icon-stroke-width: 0.125" viewBox="0 0 20 20"
       width="20" xmlns="http://www.w3.org/2000/svg">
    <path in:draw={{ duration: 1200 }}
          d="M5.49707 3C4.11636 3 2.99707 4.11929 2.99707 5.5V14.5C2.99707 15.8807 4.11636 17 5.49707 17H14.4971C15.8778 17 16.9971 15.8807 16.9971 14.5V7H9.49707C8.66864 7 7.99707 6.32843 7.99707 5.5V3H5.49707Z M8.99707 3V5.5C8.99707 5.77614 9.22093 6 9.49707 6H16.9971V5.5C16.9971 4.11929 15.8778 3 14.4971 3H8.99707Z" />
  </svg>
