...
{#if feature === 0}
    ...
    {:else if feature === 1}    
    <svg class="backdrop-icon" width="48" height="48" style="--icon-scale: 0.9" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    {:else if feature === 3}
    <svg class="backdrop-icon" height="20" style="--icon-scale: 0.9; --icon-stroke-width: 0.1" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
