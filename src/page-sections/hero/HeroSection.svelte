    ...
    <div class="buttons-spacer">
      <div class="split-button">
        ...
        <MenuFlyout bind:open={isDownloadDropdownOpen}>
          <Button aria-label="Choose download source" title="Choose download source"
...
<ContentDialog bind:open={wingetDialogOpen} title="Installing Files via winget" width="448">
  ...
  <svelte:fragment slot="footer">
    <Button on:click={copyWingetCommand} variant="accent">{wingetCommandCopied ? "Copied!" : "Copy"}</Button>
