...
<svelte:head>
  ...
  <meta content="A modern file explorer that pushes the boundaries of the platform." name="description">
  <meta content="A modern file explorer that pushes the boundaries of the platform." property="og:description">
  <meta content="Files, File Explorer, Fluent Design, Microsoft, Windows, UWP" name="keywords">
