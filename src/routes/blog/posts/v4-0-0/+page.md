...
### Updated app icon and improved design (1.)

We’re excited to unveil the updated design of Files v4, featuring a brand new app icon and a refreshed user interface!
...
### Enhancements to Dual Pane mode (2.)

The Dual Pane feature has been improved in a number of key areas to improve the expereince:

- **Add pane** is now labeled **Split pane** for clarity
- When splitting a pane, the new pane opens with the same path as the active pane
...
- When opening columns in columns view, they also auto size based on the longest file name.
