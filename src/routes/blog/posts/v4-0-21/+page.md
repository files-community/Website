---
title: Announcing Files v4.0.21
description: We're excited to announce the general availability of Files v4.0.21.
thumbnail: /blog-resources/v4-0-21/Hero.webp
date: 11/25/2025
author: files-community
---

Today we are releasing **Files v4.0.21** for all users.
...
## What's New in Files v4.0.21

- Drives without attached media (eg. sd card readers) are now hidden from the sidebar and homepage.

## Fixes

- Fixed a crash introduced in v4.0.20.
