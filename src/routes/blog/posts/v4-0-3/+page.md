---
title: Announcing Files Preview v4.0.3
description: Announcing Files Preview v4.0.3 for users of the preview version.
thumbnail: /blog-resources/v4-0-3/Hero.webp
date: 9/11/2025
author: files-community
---

Today we are releasing **Files Preview v4.0.3** for users of the preview version.
...
## What's new in Files v4.0.3

- Rolled back an updated dependency to help identify a crash.
