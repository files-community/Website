---
title: Announcing Files v4.0.34
description: We're excited to announce the general availability of Files v4.0.34.
thumbnail: /blog-resources/v4-0-34/Hero.webp
date: 3/6/2026
author: files-community
---

Today we are releasing **Files v4.0.34** for all users.
...
## What's New in Files v4.0.34

### Improved Thumbnail Performance

We're excited to share that thumbnails now display quicker, leading to a more responsive experience. Additional improvements are also being explored.

### Reduced package size

We reduced the package size by over 30 MB.
