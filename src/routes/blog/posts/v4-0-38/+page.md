---
title: Announcing Files v4.0.38
description: We're excited to announce the general availability of Files v4.0.38.
thumbnail: /blog-resources/v4-0-38/Hero.webp
date: 3/29/2026
author: files-community
---

Today we are releasing **Files v4.0.38** for all users.
...
## What's New in Files v4.0.38

### Open in Terminal behavior

The **Open in Terminal** action is now disabled when Windows Terminal is not installed.
