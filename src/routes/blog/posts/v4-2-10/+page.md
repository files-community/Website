---
title: Announcing Files v4.2.10
description: Announcing Files Preview v4.2.10 for users of the preview version.
thumbnail: /blog-resources/v4-2-10/Hero.webp
date: 8/19/2026
author: files-community
---

Today we are releasing **Files Preview v4.2.10** for users of the preview version.
...
## What's New in Files v4.2.10

### Improved startup performance

We've made significant changes under the hood that bring noticeably improved startup speed and a smaller download size. These changes are still in an early testing phase and additional improvements are being worked on. Please share any feedback you have on the [Files Discord](https://discord.gg/files).
