---
title: Announcing Files v4.2.37
description: Announcing Files Preview v4.2.37 for users of the preview version.
thumbnail: /blog-resources/v4-2-37/Hero.webp
date: 9/17/2026
author: files-community
---

Today we are releasing **Files Preview v4.2.37** for users of the preview version.
...
- Fixed the desktop Recycle Bin icon not updating after emptying the bin.
- Fixed sidebar items being able to be dragged onto themselves.
- Fixed the flatten folder option showing for archives.
