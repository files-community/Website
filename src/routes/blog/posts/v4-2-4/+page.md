---
title: Announcing Files v4.2.4
description: Announcing Files Preview v4.2.4 for users of the preview version.
thumbnail: /blog-resources/v4-2-4/Hero.webp
date: 8/9/2026
author: files-community
---

Today we are releasing **Files Preview v4.2.4** for users of the preview version.
...
## What's New in Files v4.2.4

### Improved context menu performance

Opening the right-click context menu is now noticeably faster and more responsive.
